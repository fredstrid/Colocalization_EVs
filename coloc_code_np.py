...
tableA = pd.read_csv('T114/W0/EVs 385nm.csv' , usecols=['IntensitySum1_VioBlue__IntensitySumOfChannel_VioBlue___R','CenterX__CenterX__R','CenterY__CenterY__R'], header=0)
tableB = pd.read_csv('T114/W0/EVs 475nm.csv', usecols=['IntensitySum1_FITC__IntensitySumOfChannel_FITC___R','CenterX__CenterX__R','CenterY__CenterY__R'], header=0)
tableC = pd.read_csv('T114/W0/EVs 555nm.csv', usecols=['IntensitySum1_RPe__IntensitySumOfChannel_RPe___R','CenterX__CenterX__R','CenterY__CenterY__R'], header=0)
tableD = pd.read_csv('T114/W0/EVs 630nm.csv', usecols=['IntensitySum1_APC__IntensitySumOfChannel_APC___R','CenterX__CenterX__R','CenterY__CenterY__R'], header=0)
